...
temp_folder_repo = 'synthetic/essay_repo'
temp_folder_html = 'synthetic/essay_html'
...
with open('synthetic/PaulGrahamEssays_URLs.txt') as f:
    urls = [line.strip() for line in f]

def download_essay(url):
    if '.html' in url:
...
# Use process_map to download essays in parallel    
process_map(download_essay, urls, max_workers=10)
...
with open('synthetic/PaulGrahamEssays.json', 'w') as f:
